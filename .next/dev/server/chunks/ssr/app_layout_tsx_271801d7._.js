...
const metadata = {
    ...
    description: 'Soroosh Morshedi (سروش مرشدی) — Senior Full-Stack Developer & Software Architect. متخصص در طراحی سیستم‌های Enterprise، مقیاس‌پذیر، امن و پرسرعت. تجربه در Django, Go, Next.js, PostgreSQL, Microservices, DevOps و معماری سیستم‌های مالی و فروشگاهی.',
    keywords: [
        'Soroosh Morshedi',
        'سروش مرشدی',
        'SorooshMorshedi',
    ...
    openGraph: {
        ...
        description: 'معمار و توسعه‌دهنده سیستم‌های Enterprise با تمرکز بر مقیاس‌پذیری، امنیت و کارایی. متخصص Django, Go, Nuxt.js, DevOps و سیستم‌های مالی و فروشگاهی.',
    ...
    twitter: {
        ...
        description: 'Senior Full-Stack & Software Architect — متخصص سیستم‌های مقیاس‌پذیر و امن.',
        images: [
            `${siteUrl}/og.png`
        ],
        ...
        '@graph': [
            {
                ...
                description: 'معمار و توسعه‌دهنده Full-Stack با تجربه در ساخت سیستم‌های مقیاس‌پذیر، مالی و فروشگاهی، میکروسرویس، DevOps و مهندسی داده.',
                sameAs: [
                ...
                itemListElement: [
                    {
                        '@type': 'ListItem',
                        position: 1,
                        name: 'Django / DRF (Django REST Framework)'
                    },
                    {
                        '@type': 'ListItem',
                        position: 2,
                    ...
                    },
                    {
                        '@type': 'ListItem',
                        position: 4,
                        name: 'Nuxt.js / Vue.js / Tailwind CSS'
                    },
                    {
                        '@type': 'ListItem',
                        position: 5,
                        name: 'PostgreSQL / MongoDB / MySQL / Redis'
                    },
                    {
                        '@type': 'ListItem',
                        position: 6,
                        name: 'Docker / Docker Compose / CI/CD (GitHub Actions, GitLab CI)'
                    },
                    {
                        '@type': 'ListItem',
                        position: 7,
                        name: 'Microservices Architecture / Event-Driven Design (EDA)'
                    },
                    {
                        '@type': 'ListItem',
                        position: 8,
                        name: 'Software Architecture / System Design / Scalable Systems'
                    },
                    {
                        '@type': 'ListItem',
                        position: 9,
                        name: 'DevOps / Linux Server Administration / Nginx / Gunicorn / Uvicorn'
                    },
                    {
                        '@type': 'ListItem',
                        position: 10,
                        name: 'Testing & QA / Pytest / Unit & Integration Testing'
                    },
                    {
                        '@type': 'ListItem',
                        position: 11,
                        name: 'GraphQL (Ariadne, Strawberry, Graphene) / RESTful API Design'
                    },
                    {
                        '@type': 'ListItem',
                        position: 12,
                        name: 'Caching / Redis / Query Optimization / Performance Tuning'
                    },
                    {
                        '@type': 'ListItem',
                        position: 13,
                        name: 'Security / SSL / OAuth2 / JWT / Firewall / Monitoring'
                    },
                    {
                        '@type': 'ListItem',
                        position: 14,
                        name: 'Financial Systems / Wallet Management / Audit Logging'
                    },
                    {
                        '@type': 'ListItem',
                        position: 15,
                        name: 'Frontend Tooling / Webpack / Vite / NPM / Yarn'
                    }
                ]
            },
            {
                ...
                mainEntity: [
                    {
                        ...
                        acceptedAnswer: {
                            '@type': 'Answer',
                            text: 'سروش مرشدی توسعه‌دهنده فول‌استک و معمار نرم‌افزار است که روی سیستم‌های Enterprise، فین‌تک، e-commerce، میکروسرویس، Django، Nuxt.js، Next.js و DevOps تمرکز دارد.'
                        }
                    },
                    {
                        '@type': 'Question',
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("body", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "absolute -top-24 -left-24 h-72 w-72 bg-[#fb21a9] blur-[100px] opacity-25"
                            }, void 0, false, {
                                fileName: "[project]/app/layout.tsx",
                                lineNumber: 276,
                                columnNumber: 9
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "absolute -bottom-24 -right-24 h-72 w-72 bg-[#05ecf4] blur-[100px] opacity-25"
                            }, void 0, false, {
                                fileName: "[project]/app/layout.tsx",
                                lineNumber: 277,
                                columnNumber: 9
